      ...
      >
        <Grid item xs={12}>
          ...
          >
            ...
            <Typography variant="body1" color="initial">
              Đây là mục bạn cần tóm tắt về các thông tin cơ bản về bản thân,
              bao gồm: họ tên, ngày/tháng/năm sinh, địa chỉ, số điện thoại và
              email liên lạc. Với những thông tin giới thiệu bản thân trong CV,
              nhà tuyển dụng có thể liên lạc với bạn dễ hơn khi đạt yêu cầu. Bên
              cạnh đó, nếu bạn có những trích dẫn mục tiêu sống hay những câu
              nói mà bạn tâm đắc, bạn có thể viết một cách ngắn gọn để thể hiện
              bản thân.
            </Typography>
          </Box>
          {/* Trinh do hoc van */}
          ...
          >
            ...
            <Typography variant="body1" color="initial">
              Tại mục trình độ học vấn, bạn nên ghi về bậc học cao nhất của mình
              và liệt kê thêm những thành tích, giải thưởng đã đạt được trong
              quá trình học tập (nếu có). Ngoài ra, bạn có thể ghi thêm về những
              dự án, chương trình nghiên cứu, các khóa học chuyên môn, nghiệp vụ
              có liên quan đến vị trí ứng tuyển mà bạn đã tham gia. Cho nhà
              tuyển dụng thấy được năng lực làm việc cũng như tính cầu thị, ham
              học hỏi trong bạn.
            </Typography>
          </Box>
          {/* ky nang */}
          ...
          >
            ...
            <Typography variant="body1" color="initial">
              Đây là phần để nói đến những công việc bạn đã từng làm trước đây,
              tuy nhiên bạn không nên liệt kê hết vào CV. Điều đó sẽ làm cho CV
              trở nên dài và không có điểm nhấn cụ thể. Vì thế, bạn chỉ nên viết
              những kinh nghiệm công việc có liên quan đến vị trí ứng tuyển,
              nhằm gây được ấn tượng với nhà tuyển dụng.
            </Typography>
          </Box>
          {/* Mục tiêu */}
          <Box
          ...
          >
            ...
            <Typography variant="body1" color="initial">
              Hiểu đơn giản, mục tiêu nghề nghiệp là đích đến của sự nghiệp mà
              bạn mong muốn đạt được trong tương lai, thông qua việc định hướng
              và trang bị những kiến thức, kinh nghiệm cần có. Với mục tiêu nghề
              nghiệp, bạn cần phân biệt rõ giữa mục tiêu ngắn hạn và đâu là mục
              tiêu dài hạn để biết được bản thân cần làm gì và phải làm gì để
